...
public class DetailPagerAdapter extends ParsePagerAdapter<ParseWallpaper> {
    public final static String TAG = DetailPagerAdapter.class.getSimpleName();

    private Context mContext;
    private int mResourceId;
    private Utils mUtils;
    private FileUtils mFileUtils;
    public DetailPagerAdapter(ParseQueryAdapter.QueryFactory<ParseWallpaper> factory,Context context, int resourceId, ArrayList<ParseWallpaper> data){
        super(factory,data);
